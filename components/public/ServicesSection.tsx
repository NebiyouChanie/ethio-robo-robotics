      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            { icon: <Users className="w-6 h-6 text-cyan-400" />, title: "STEM‑Teacher Training", desc: "Transforms educators into confident robotics instructors with practical pedagogy." },
            ...
            { icon: <Monitor className="w-6 h-6 text-cyan-400" />, title: "Practice & Facilities", desc: "Access to fields, scrimmages, and mock judging for competition readiness." },
          ].map((s, i) => (
