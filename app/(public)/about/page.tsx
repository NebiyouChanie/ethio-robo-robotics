    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="py-24 px-4 bg-gray-800/50">
        <div className="max-w-5xl mx-auto text-center">
          <div ref={refHeroText} className={`space-y-6 animate-fade-up ${inViewHeroText?.isIntersecting ? 'visible' : ''}`}>
            <div className="text-sm brand-text tracking-wider">ABOUT ETHIO ROBO ROBOTICS</div>
            <h1 className="text-5xl lg:text-5xl font-medium leading-tight">Who <span className="brand-text">We </span>Are</h1>
      ...
      <section className="py-24 px-4 bg-gray-800/50">
        <div className="max-w-7xl mx-auto">
          <h2 ref={refMVVHead} className={`text-3xl lg:text-4xl font-semibold text-center mb-12 animate-fade-up ${inViewMVVHead?.isIntersecting ? 'visible' : ''}`}>Mission, Vision <span className="brand-text"> & </span> Values</h2>
          <div ref={refMVVGrid} className={`grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-up ${inViewMVVGrid?.isIntersecting ? 'visible' : ''}`}>
            <div className="bg-gray-900/60 p-8 rounded-xl border border-gray-800">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <Target className="w-12 h-12" color="url(#brandGradient)" />
              </div>
            ...
            <div className="bg-gray-900/60 p-8 rounded-xl border border-gray-800">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <Eye className="w-12 h-12" color="url(#brandGradient)" />
              </div>
            ...
            <div className="bg-gray-900/60 p-8 rounded-xl border border-gray-800">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <Handshake className="w-12 h-12" color="url(#brandGradient)" />
              </div>
              <div className="text-xl font-semibold mb-2">Our Values</div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 ref={refHistoryHead} className={`text-3xl lg:text-4xl font-semibold  mb-10 text-center animate-fade-up ${inViewHistoryHead?.isIntersecting ? 'visible' : ''}`}>Our <span className="brand-text">History</span></h2>
              ...
              {[
                ...
                <div key={i} className={`relative md:grid md:grid-cols-2 md:gap-12 items-start`}>
                  ...
                  <div className={`relative bg-gray-800/60 border border-gray-700 rounded-xl p-6`}> 
                    {/* <div className="absolute -left-3 md:-translate-x-1/2 md:left-1/2 top-6 w-3 h-3 rounded-full brand-gradient border-2 border-gray-900" /> */}
                    <div className="text-sm brand-text font-semibold">{m.year}</div>
